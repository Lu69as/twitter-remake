    ...
    <section class="mainWidget">
        <?php
            if(!isset($_COOKIE["user"])) {
                ...
                echo '</p><div class="login_tabs">
                    ...
                    <form class="sign_up" action="./queries/log-in.php" method="post">
                        <div>
                            <div><label for="userId">User ID*</label>
                                <input required="yes" maxlength="30" type="text" name="userId" id="userId" placeholder="exampler123"></div>
                            <div><label for="password">Password*</label>
                                <input required="yes" maxlength="40" type="password" name="password" id="password" placeholder="Pass123"></div>
                        </div>
                        <div>
                            <div><label for="userName">Username*</label>
                                <input required="yes" maxlength="30" type="text" name="userName" id="userName" placeholder="The Great Exampler"></div>
                            <div><label for="profilePic">Profile picture</label>
                                <input maxlength="255" type="text" name="profilePic" id="profilePic" placeholder="https://example.com/profile.jpg"></div>
                        </div>
                        <label for="desc">Description</label><textarea name="desc" id="desc" 
        ...
        <div class="posts">
            <div class="post">
                ...
                <div class="content">
                    <p class="user">
                        <span class="userName">Lu69as</span>
